...
export default function ExtrasAddOns() {
  ...
  return (
    <div className="extras-add-ons app-subview">
      ...
      <main className="app-subview__body">
        <div className="extras-add-ons__header glass-panel">
          <span className="extras-add-ons__eyebrow">Coming soon</span>
          ...
          <div className="extras-add-ons__positioning-note">
            <p>
        ...
        <div className="extras-add-ons__grid">
          {ADDONS.map(addon => (
            <div key={addon.id} className="extras-add-ons__card glass-panel">
              ...
              <div className="extras-add-ons__card-footer">
